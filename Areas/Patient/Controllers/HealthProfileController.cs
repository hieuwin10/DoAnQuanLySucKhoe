...
namespace DoAnChamSocSucKhoe.Areas.Patient.Controllers
{
    ...
    public class HealthProfileController : Controller
    {
        ...
        // GET: Patient/HealthProfile/Edit
        ...
        // POST: Patient/HealthProfile/Edit
        [HttpPost]
        ...
        public async Task<IActionResult> Edit(HoSoSucKhoe hoSo)
        {
            ...
            if (existing == null)
            {
                ...
                var lichSu = new LichSuHoSoSucKhoe
                {
                    ...
                    NguoiThayDoiId = user.Id, // Người thực hiện thay đổi (có thể là Caregiver)
                    NgayThayDoi = DateTime.Now,
                    LoaiThayDoi = "Tạo mới",
                    ThayDoiNoiDung = "Tạo hồ sơ sức khỏe mới"
                };
            ...
            else
            {
                ...
                var lichSu = new LichSuHoSoSucKhoe
                {
                    ...
                    ThayDoiNoiDung = "Bệnh nhân cập nhật thông tin sức khỏe"
                };
                _context.LichSuHoSoSucKhoes.Add(lichSu);
            }
        ...
        // GET: Patient/HealthProfile/History
        public async Task<IActionResult> History()
        {
            ...
            var hoSo = await _context.HoSoSucKhoes
                .FirstOrDefaultAsync(h => h.NguoiDungId == user.Id);
